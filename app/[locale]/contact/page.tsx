    ...
    <main style={{ background: "#ffffff", minHeight: "80vh" }}>
      <section className="section">
        <div className="container">
          <div>
            <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.04em", color: "#2B2520", margin: "8px 0 12px" }}>{t("title")}</h1>
